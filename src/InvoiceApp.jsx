            ...
            <div className="container">
                ...
                <div className="card my-3">
                    ...
                    <div className="card-body">
                        ...
                        <ListItemsView title="Productos de la factura" items={items}  handlerDeletedItem={ id => handlerDeletedItem(id)}/>
                        <TotalView total={total} />
                        <button className="btn btn-secondary m-3"
                        onClick= {onActiveForm}> {!activeForm ? 'Agregar Item': 'No Agregar'}</button>
